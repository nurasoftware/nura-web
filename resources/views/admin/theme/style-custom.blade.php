    ...
    <div class="card-body">
        ...
        <form method="post">
            ...
            <div class="row">
                <div class="col-sm-4 col-md-3 col-12">
                    <div class="form-group mb-4">
                        <input id="text_color" name="text_color" value="{{ $style->text_color ?? config('nura.defaults.font_color') }}">
                        <label>{{ __('Main text color') }}</label>
                        <div class="mt-1 small"> {{ strtoupper($style->text_color) ?? config('nura.defaults.font_color') }}</div>
                        <script>
                            $('#text_color').spectrum({
                                type: "color",
                                showInput: true,
                ...
                <div class="col-sm-4 col-md-3 col-12">
                    <div class="form-group mb-4">
                        <input id="link_color" name="link_color" value="{{ $style->link_color ?? config('nura.defaults.link_color') }}">
                        <label>{{ __('Link color') }}</label>
                        <div class="mt-1 small"> {{ strtoupper($style->link_color) ?? config('nura.defaults.link_color') }}</div>
                        <script>
                            $('#link_color').spectrum({
                                type: "color",
                                showInput: true,
                ...
                <div class="col-sm-4 col-md-3 col-12">
                    <div class="form-group mb-4">
                        <input id="link_hover_color" name="link_hover_color" value="{{ $style->link_hover_color ?? config('nura.defaults.link_color_hover') }}">
                        <label>{{ __('Link color on mouse hover') }}</label>
                        <div class="mt-1 small"> {{ strtoupper($style->link_hover_color) ?? config('nura.defaults.link_color_hover') }}</div>
                        <script>
                ...
                <div class="col-sm-4 col-md-3 col-12">
                    <div class="form-group mb-4">
                        <input id="link_underline_color" name="link_underline_color" value="{{ $style->link_underline_color ?? config('nura.defaults.link_color_underline') }}">
                        <label>{{ __('Underline color') }}</label>
                        <div class="mt-1 small"> {{ strtoupper($style->link_underline_color) ?? config('nura.defaults.link_color_underline') }}</div>
                        <script>
                ...
                <div class="col-sm-4 col-md-3 col-12">
                    <div class="form-group mb-4">
                        <input id="link_underline_color_hover" name="link_underline_color_hover" value="{{ $style->link_underline_color_hover ?? config('nura.defaults.link_color_underline_hover') }}">
                        <label>{{ __('Underline color on hover') }}</label>
                        <div class="mt-1 small"> {{ strtoupper($style->link_underline_color_hover) ?? config('nura.defaults.link_color_underline_hover') }}</div>
                        <script>
                ...
                <div class="col-sm-4 col-md-3 col-12">
                    <div class="form-group mb-4">
                        ...
                        <div class="mt-1 small"> {{ strtoupper($style->caption_color) ?? config('nura.defaults.link_color_underline_hover') }}</div>
                        <script>
