        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.theme.buttons.index') }}">{{ __('Buttons') }}</a></li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-7 col-md-6 order-md-2 order-last">
                    <div class="float-end">
                        ...
                        @include('admin.theme.modals.create-button')
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-grid gap-2">
                                        ...
                                        <a class="btn btn-gear btn-sm mb-2" href="{{ route('admin.theme.buttons.show', ['id' => $button->id]) }}">{{ __('Edit style') }}</a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form method="POST" action="{{ route('admin.theme.buttons.show', ['id' => $button->id]) }}">
                                                                {{ csrf_field() }}
                                                                {{ method_field('DELETE') }}
