        ...
        <div class="col-12">
            <nav aria-label="breadcrumb" class="breadcrumb-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.theme') }}">{{ __('Template builder') }}</a></li>
                    <li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.theme.menu') }}">{{ __('Menu links') }}</a></li>
                    <li class="breadcrumb-item active">{{ __('Dropdown links') }} - {{ get_menu_link_label($parent_link->id) }}</li>
                </ol>
            </nav>
        </div>
    </div>
