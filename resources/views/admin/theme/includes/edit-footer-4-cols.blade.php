                ...
                @foreach (footer_blocks($footer, $col = 1, $show_hidden = true) as $block)
                    <div class="builder-block movable" id="item-{{ $block->id }}">
                        <div class="float-end ms-2">
                            ...
                            <a href="{{ route('admin.theme.footer.block', ['id' => $block->id]) }}" class="btn btn-primary btn-sm">{{ __('Manage content') }}</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form method="POST" action="{{ route('admin.theme.footer.content.delete', ['footer' => $footer, 'block_id' => $block->id]) }}">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
            ...
            $("#sortable_1").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        data: data,
                        type: 'POST',
                        url: "{{ route('admin.theme.footer.sortable', ['footer' => $footer, 'col' => 1]) }}",
                    });
                }
            });
            ...
            $("#sortable_2").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        data: data,
                        type: 'POST',
                        url: "{{ route('admin.theme.footer.sortable', ['footer' => $footer, 'col' => 2]) }}",
                    });
                }
            });
            ...
            $("#sortable_3").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        data: data,
                        type: 'POST',
                        url: "{{ route('admin.theme.footer.sortable', ['footer' => $footer, 'col' => 3]) }}",
                    });
                }
            });
            ...
            $("#sortable_4").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        data: data,
                        type: 'POST',
                        url: "{{ route('admin.theme.footer.sortable', ['footer' => $footer, 'col' => 4]) }}",
                    });
                }
            });
