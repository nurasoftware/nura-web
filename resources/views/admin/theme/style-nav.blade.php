            ...
            <div class="row">
                <div class="col-sm-4 col-md-3 col-xxl-2 col-12">
                    <div class="form-group">
                        ...
                        <select class="form-select" name="navbar_height">
                            <option @if (($theme_config->navbar_height ?? null) == '65px') selected @endif value="65px">{{ __('Normal') }}</option>
                            <option @if (($theme_config->navbar_height ?? null) == '50px') selected @endif value="50px">{{ __('Small') }}</option>
                            <option @if (($theme_config->navbar_height ?? null) == '90px') selected @endif value="90px">{{ __('Large') }}</option>
                        </select>
                    </div>
                </div>
            </div>
