            ...
            <form method="post">
                ...
                <style>
                    .btn_style_{{ $button->id }} {
                        background-color: {{ $button->bg_color ?? config('nura.defaults.button_bg_color') }};
                        color: {{ $button->font_color ?? config('nura.defaults.button_font_color') }};
                    ...
                    .btn_style_{{ $button->id }}:hover {
                        background-color: {{ $button->bg_color_hover ?? config('nura.defaults.button_bg_color_hover') }};
                        color: {{ $button->font_color_hover ?? config('nura.defaults.button_font_color') }};
                        font-weight: {{ $button->font_weight ?? 'normal' }};
                    }
                </style>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 col-md-4">
                        <div class="form-group mb-4">
                            ...
                            <div class="mt-1 small"> {{ strtoupper($button->font_color) ?? config('nura.defaults.button_font_color') }}</div>
                            <script>
                                $('#font_color').spectrum({
                                    type: "color",
                                    showInput: true,
                ...
                <div class="row">
                    <div class="col-12 col-lg-3 col-md-4">
                        <div class="form-group mb-4">
                            <input id="bg_color_hover" name="bg_color_hover" value="{{ $button->bg_color_hover ?? config('nura.defaults.button_bg_color_hover') }}">
                            <label>{{ __('Background color on mouse hover') }}</label>
                            <div class="mt-1 small"> {{ strtoupper($button->bg_color_hover) ?? config('nura.defaults.button_bg_color_hover') }}</div>
                            <script>
                    ...
                    <div class="col-12 col-lg-3 col-md-4">
                        <div class="form-group mb-4">
                            <input id="font_color_hover" name="font_color_hover" value="{{ $button->font_color_hover ?? config('nura.defaults.button_font_color_hover') }}">
                            <label>{{ __('Font color on mouse hover') }}</label>
                            <div class="mt-1 small"> {{ strtoupper($button->font_color_hover) ?? config('nura.defaults.button_font_color_hover') }}</div>
                            <script>
