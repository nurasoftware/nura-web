                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card-box noradius noborder bg-light">
                            ...
                            <a class="btn btn-gear" href="{{ route('admin.accounts.index') }}">{{ __('View accounts') }}</a>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card-box noradius noborder bg-light">
                            <i class="bi bi-file-text float-end text-secondary"></i>
                            <div class="text-dark text-uppercase mb-4 fw-bold">{{ __('Pages') }}</div>
                            <div class="mb-3 text-secondary fs-6 fw-bold">{{ $count_pages ?? 0 }} {{ __('pages') }},</div>
                            <a class="btn btn-gear" href="{{ route('admin.pages.index') }}">{{ __('View pages') }}</a>
                        </div>
                    </div>
                </div>
                <!-- end row -->
