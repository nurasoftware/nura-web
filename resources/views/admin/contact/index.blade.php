        ...
        @if (($config->module_contact ?? null) == 'inactive')
            <div class="alert alert-danger">
                {{ __('Warning. Contact module is not active. You can manege content, but module is not available on the website') }}. <a
                    href="{{ route('admin.config', ['module' => 'modules']) }}">{{ __('Manage modules') }}</a>
            </div>
        @endif
                            ...
                            @foreach ($messages as $message)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($message->geo_country_code)
                                            <div class="mt-2">
                                                {!! flag($message->geo_country_code) !!} @if ($message->geo_city)
                                                    {{ $message->geo_city }},
                                                @endif {{ $message->geo_country }}
                                            </div>
                                        @endif
                                    </td>
