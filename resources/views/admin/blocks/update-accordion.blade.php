    ...
    <div class="card-body">
        ...
        <form id="updateBlock" method="post" enctype="multipart/form-data">
            ...
            <div class="card p-3 bg-light mb-4">
                ...
                @php
                    $title_font_size = $block_extra['title_size'] ?? '1.1rem';
                @endphp
                ...
                <div class="col-12">
                    <div class="form-group">
                        <input class="form-control form-control-color" name="title_bg_color" id="title_bg_color" value="{{ $block_extra['title_bg_color'] ?? '#F8F9FA' }}">
                ...
                <div class="card p-3 bg-light mb-4">
                    ...
                    <div id="hidden_div_header_{{ $lang->id }}" style="display: @if ($header_array['add_header'] ?? null) block @else none @endif" class="mt-2">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" name="header_content_{{ $lang->id }}">{{ $header_array['content'] ?? null }}</textarea>
                        </div>
                    </div>
                </div>
