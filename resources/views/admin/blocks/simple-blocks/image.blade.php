                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        @if ($content_array['image'] ?? null)
                            <div class="mt-3"></div>
                            <a target="_blank" href="{{ asset('uploads/' . $content_array['image']) }}"><img style="max-width: 300px; max-height: 100px;" src="{{ asset('uploads/' . $content_array['image']) }}" class="img-fluid"></a>
