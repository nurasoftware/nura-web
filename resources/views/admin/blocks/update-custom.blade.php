    ...
    <div class="card-body">
        ...
        <form id="updateBlock" method="post">
            ...
            <div class="alert alert-info">
                {{ __('HTML / CSS / JavaScript and PHP code is allowed') }}
            </div>
            ...
            @foreach ($content_langs as $lang)
                ...
                <textarea name="content_{{ $lang->id }}" class="prism-live line-numbers language-html fill">{{ $lang->block_content->content }}</textarea>
