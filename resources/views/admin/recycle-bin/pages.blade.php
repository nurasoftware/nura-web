                        ...
                        <tbody>
                            ...
                            @foreach ($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($item->translations as $lang_content)
                                            ...
                                            <span @if (($lang_content->language->is_default ?? null) == 1) class="fw-bold fs-6" @endif>
                                                ...
                                                @endif 
                                                <a target="_blank" href="{{ $lang_content->url }}"><b>{{ $lang_content->title }}</b></a>
                                            </span>
                                        ...
                                        <small class='text-muted'>
                                            ...
                                            @if ($item->parent_id)
                                                <b>{{ __('Parent page') }}:</b> <a target="_blank" href="{{ $item->parent->content->url ?? null }}">{{ $item->parent->content->title }}</a>
                                                <div class="clearfix"></div>
                                            @endif
