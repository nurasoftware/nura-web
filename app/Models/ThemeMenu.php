    ...
    public static function generate_menu_links()
    {
        ...
        foreach ($langs as $lang) {
            ...
            foreach ($links as $link) {
                ...
                if ($link->type == 'posts') {
                    if ($lang->id == Language::get_default_language()->id) $url = route('posts');
                    else $url = route('posts.' . $lang->code);
                }
                ...
                if ($link->type == 'dropdown') {
                    ...
                    foreach ($dropdown_links as $dropdown_link) {
                        ...
                        if ($dropdown_link->type == 'posts') {
                            if ($lang->id == Language::get_default_language()->id) $dropdown_url = route('posts');
                            else $dropdown_url = route('posts.' . $lang->code);
                        }
